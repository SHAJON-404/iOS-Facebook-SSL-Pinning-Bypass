...
# 🔐 iOS-Facebook-SSL-Pinning-Bypass
📡 Capture and inspect Facebook's network traffic on iOS — no jailbreak required.
...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      <td align="center">520.0.0.38.101</td>
      <td align="center">✅ Bypassed</td>
      <td align="center">✅ Yes</td>
      <td align="center"><a href="https://github.com/shajon-dev/iOS-Facebook-SSL-Pinning-Bypass/releases">Download Link</a></td>
    </tr>
    <tr>
      <td align="center">500.0.0.52.98</td>
      <td align="center">✅ Bypassed</td>
      <td align="center">✅ Yes</td>
      <td align="center"><a href="https://github.com/shajon-dev/iOS-Facebook-SSL-Pinning-Bypass/releases">Download Link</a></td>
    </tr>
...
## 🔧 Setup Process
 ...
 4. 🚀 **Open the Facebook app**. You will immediately see a popup: *"Allow 'Facebook' to find devices on local networks?"*. ⚠️ You **MUST** tap **Allow**. Once allowed, all traffic will be seamlessly captured in `mitmproxy/mitmweb` without any issues.
